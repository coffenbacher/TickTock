...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InstrumentModel.instrument_type'
        db.add_column('inventory_instrumentmodel', 'instrument_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['inventory.InstrumentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InstrumentModel.instrument_type'
        db.delete_column('inventory_instrumentmodel', 'instrument_type_id')
    ...
    models = {
        ...
        'inventory.instrumentmodel': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instrument_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['inventory.InstrumentType']"}),
