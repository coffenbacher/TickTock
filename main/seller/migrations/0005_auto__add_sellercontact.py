...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SellerContact'
        db.create_table(u'seller_sellercontact', (
        ...
        db.send_create_signal(u'seller', ['SellerContact'])


    def backwards(self, orm):
        # Deleting model 'SellerContact'
        db.delete_table(u'seller_sellercontact')
    ...
    models = {
        ...
        u'seller.sellercontact': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'SellerContact'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
