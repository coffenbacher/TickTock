...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Seller.subtitle'
        db.alter_column(u'seller_seller', 'subtitle', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Seller.subtitle'
        raise RuntimeError("Cannot reverse this migration. 'Seller.subtitle' and its values cannot be restored.")
